...
app.delete('/api/v1/recipes/:recipeId', confirmAuth.authenticate, HandleRecipe.deleteRecipe);
app.put('/api/v1/recipes/:recipeId', confirmAuth.authenticate, HandleRecipe.updateRecipe);
